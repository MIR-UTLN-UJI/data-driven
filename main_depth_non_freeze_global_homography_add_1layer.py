...
if __name__ == '__main__':
    ...
    # in additoin to adding one conv2d layer
    ...
    #print(model.features[0][1].weight.requires_grad)
    ...
    # Set up tensorboard
    writer = SummaryWriter(os.path.join('logs_depth_non_freeze_global_homography_add_1layer', os.path.basename(os.path.normpath(args.path)), args.loss))
    ...
    for epoch in tqdm.tqdm(range(args.epochs)):
        ...
        for batch in train_loader:
            ...
            #wieghts and biases implementation
