...
import modified datasets as datasets
import losses
import models
...
if __name__ == '__main__':
    ...
    model.features[0][0]=torch.nn.Conv2d(6, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
    ...
    # Set up tensorboard
    writer = SummaryWriter(os.path.join('logs_original_local_homography_sequence_input', os.path.basename(os.path.normpath(args.path)), args.loss))
